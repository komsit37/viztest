//https://github.com/MdSalih/Kdb-Stuff/tree/master/IPCWebParse

if[0=system"p"; system"p 5555"];                                                / Listen on random port if not give -p arg
...
//sample data
.sample.t: ([]date:.z.d + til 10; v: til 10);